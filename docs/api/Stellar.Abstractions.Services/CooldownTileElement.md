...
| [FallbackLabel](CooldownTileElement/FallbackLabel.md) { get; set; } | Drawn centered on the tile only when Icon() is null (e.g. a 2-letter abbreviation). Null/empty = nothing. |
